...
subject = {
        ...
        'Литература':
            ...
            50, 51, 52, 54,55, 56, 57, 58, 59, 61, 62, 63, 64, 65, 66, 68, 69, 70, 71, 72, 73, 77, 80, 84, 87, 90, 94, 97, 100},
        ...
        'История' :
            {4, 8, 11, 15, 18, 22, 25, 29, 32, 34, 35, 36, 37, 38, 40, 41, 42, 43, 44, 45, 47, 48, 49, 50, 51, 52,
             54, 55, 56,57, 58, 60, 61, 62, 63, 64, 65, 67, 68, 69, 70, 71, 72, 75, 77, 79, 82, 84, 86, 89, 91, 93, 96, 98, 100},
...
if chose == '1' :
    ...
    user_input_prav=['Информатика''Биология','Физика','Математика','География ','Литература','Химия','История','Обществознание']
    count=0
    a=[]
    i=0
